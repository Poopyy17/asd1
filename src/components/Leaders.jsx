  ...
  return (
    <div className="w-full mt-20">
      <div className="w-full text-center px-5">
        <h1 className="lg:text-7xl md:text-5xl sm:text-xl text-3xl text-black font-dinnext font-black">
          OUR LEADERS
        </h1>
      </div>
      <div className="max-w-[1340px] mx-auto px-5 md:px-20 grid md:grid-cols-2 pt-5 gap-8 ">
        ...
        <div className="bg-white rounded-lg shadow-[0px_0px_4px_1px_#e2e8f0] p-4 flex flex-col items-center relative">
          ...
          <div className="flex flex-col items-center">
            <p className="text-lg sm:text-xl md:text-2xl text-orange-500 font-dinnext font-bold text-center -mb-2">
              <span style={{ fontFamily: "inherit" }}>“</span>
              PRECIOUS IRRESISTIBLE
              <span style={{ fontFamily: "inherit" }}>”</span>
            </p>
            <h1 className="text-xl sm:text-2xl md:text-4xl font-dinnext font-black text-gray-900 py-2 text-center">
              Governor <br /> Prescy Yulo
            </h1>
            <p className="text-sm sm:text-base md:text-lg italic pt-2 text-center">
              <span style={{ fontFamily: "inherit" }}>“</span>
